...
Contributors: sharethis, scottstorebloom, surlyrightclick,
Tags: social buttons, sharethis, share this, social sharing, share buttons, social media buttons
...
Integrate ShareThis share buttons seamlessly into your WordPress site.
...
[youtube https://www.youtube.com/watch?v=Skxxt9BxTf0]
...
2. Sticky share button settings.
3. Share button controls included on post and page editors.
4. Example of Inline share buttons.
5. Example of Sticky share buttons.

== Installation ==

Install ShareThis Share Buttons just like any other plugin. Simply download the file directly from this page or search for us in the WordPress directory and click "Install".
After you install and activate the plugin, simply configure your buttons and create an account. You’ll be redirected back to the plugin settings page where you can specify where and how your new buttons will appear on your site.
