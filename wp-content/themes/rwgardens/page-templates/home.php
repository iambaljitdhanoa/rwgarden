...
?> 
  ...
  <section class="designing-sec data-section">
        <div class="social-icons">
           <?php get_sidebar('socail'); ?>
        </div>
        <div class="container">
            <div class="row"> 
                <div class="col-md-6 col-sm-12 col-xs-12 lftdiv">
                   <?php  
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 rytdiv">
                    <div class="theme-sec">
                        <div class="img-div">
						<?php
                    ...
                    <div class="theme-sec">
                        <div class="img-div">
                            <a href="<?php bloginfo("url"); ?>/garden-themes"><?php
						...
						$urlr = $aggregate_image['0'];
                           ...
                           <img src="<?php echo $urlr;?>" alt="<?php the_title();?>" />
							<?php
							}
							?>
                                <div class="hover-div">
                        ...
                        <div class="theme-text">
                            <?php echo $garden = get_field("garden",$page_id);?> <a href="<?php bloginfo("url"); ?>/garden-themes">read more<i class="fa fa-caret-right" aria-hidden="true"></i></a> </div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="popup-gallery">
                  ...
                  <h1> <?php echo $garden_themes_title = get_field("garden_themes_title",$page_id);?></h1> </div>
						...
						$post_id=$post->ID;
					?> 
                    <div class="col-md-4 col-sm-4 col-xs-12 galery-sec">
					<?php
					$post_id= $post->ID;
    ...
    <section class="three-d-design">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12 vid-outer">
                    <div class="video-div video" style="background-image:url(<?php echo esc_url( get_template_directory_uri() ); ?>/images/dummy-vid.jpg);">
					<img alt="youtube video" src="https://i.imgur.com/ZhEEocz.jpg" data-video="<?php echo $youtube_link = get_field("youtube_link",$page_id);?>?autoplay=1&rel=0">
            ...
            <div class="row">
			    ...
			    while ( have_posts() ) : the_post(); ?>
					...
					<?php
                       ...
                       <div class="sec1 item" style="background-image:url(<?php echo $urla;?> )"> <a href="<?php the_permalink(); ?>"> </a>
                            <strong><?php echo $pfx_date = get_the_date('j', $post->ID); ?> <span><?php echo $pfx_date = get_the_date('M', $post->ID); ?></span></strong> </div>
							<?php
							}else
							{
						
							?>
						 <div class="sec1 item" style="background-image:url(http://placehold.it/460x307);"><a href="<?php the_permalink(); ?>"></a>
                            <strong><?php echo $pfx_date = get_the_date('j', $post->ID); ?> <span><?php echo $pfx_date = get_the_date('M', $post->ID); ?></span></strong> </div>
							<?php 
							}
							?>
